...
network=model.fit(xtrain,ytrain,batch_size=128,epochs=2,validation_split=0.2)
...
testLabelsPredict=model.predict(xtest)

testLabelsPredict=np.argmax(testLabelsPredict,axis=1)
